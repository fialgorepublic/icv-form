...
const EnrollmentAgreement = () => {
  ...
  const validationSchema = yup.object({
    agreement_signature: yup.string().required("* Please Add Your Signature"),
  });
  ...
  const handleSave = async (values) => {
    ...
    axios
      ...
      .then(function (res) {
        ...
        toast.success("Your agreement updated successfully");
        navigate("/");
        setLoader(false);
      });
  };
  ...
  const formik = useFormik({
    initialValues: { agreement_signature: "", agreement_date: new Date() },
              ...
              <Grid container m={2}>
                <Grid item md={12}>
                  ...
                  <Typography
                    ...
                    color="inherit"
                    component="div"
                    sx={{ ml: "50px", mt: "18px", fontSize: "16px" }}
                  >
                    Policy
                  </Typography>
                  <Typography
                    ...
                    color="inherit"
                    component="div"
                    sx={{ ml: "60px", mt: "8px", fontSize: "18px" }}
                  >
            ...
            >
              <Grid container m={2}>
                <Typography
                  ...
                  color="inherit"
                  component="div"
                  sx={{ ml: "60px", mt: "8px", mb: "20px", fontSize: "18px" }}
                >
                  I have read, understood and agree to Terms of Agreement
                  mentioned above. I will keep a copy of this enrolment
                  agreement and receipts of any payments of tuition or
            ...
            <form onSubmit={formik.handleSubmit}>
              <Box component="section" textAlign={"center"} fontWeight={600}>
                <TextField
                  ...
                  fullWidth
                  sx={{ display: "none" }}
                  value={formik.values.agreement_signature}
                ...
                <FormHelperText sx={{ color: "#d32f2f", textAlign: "center" }}>
                  {formik.touched.agreement_signature &&
                    formik.errors.agreement_signature}
                </FormHelperText>
                <input
                  name="agreement_date"
